...
Participation Buddies as a form of mutual support is currently **distributed** via an algorithm that randomly pairs all active (not on hiatus) participants. 
...
* For more information on the Conduct Supporter roles see the [Conduct Supporter agreement](https://radhousing.org/brassica/handbook/agreements/supporter_agreement).

##### Why aren’t any other types of supporter roles included in these guidelines?

* Other forms of support are described in other agreements, including the onboarding supporter role in the [Entry and Exit Pathway Agreement](../entry_and_exit_pathways) and the Conduct Supporter roles in the [Conduct Supporter agreement](https://radhousing.org/brassica/handbook/agreements/supporter_agreement).
