...
In this context, _consent_ is similar to consensus, but instead of seeking the best decision for the group, consent is the absence of objections ('I can live with this decision'). Rather than aiming to resolve all concerns, the proposal is only amended for 'principled objections' (such as “I think there is a serious risk this proposal could do harm”, not “I don’t like it”).
...
In between Assemblies, crew can also seek [_advice_](https://help.loomio.com/en/guides/advice_process/index.html) to increase the range of perspectives informing the decisions delegated to them
