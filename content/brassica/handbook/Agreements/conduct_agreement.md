...
- This agreement assumes familiarity with our broader set of Participation Agreements, and any ambiguities in this agreement should be interpreted in that context. In this context:
  ...
  - If we have a Conduct Collaborators Agreement then references to 'conduct supporter(s)' indicate those participants currently acting in the relevant conduct supporter role(s) it describes.
...
This Conduct Agreement draws on an unpublished version of the [Code of Conduct prepared by the CommonGuide](https://common.guide/groupings/grassroots-ecosystem/code-of-conduct/) highlighting ways to include transformative justice considerations.
