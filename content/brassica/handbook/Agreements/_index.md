...
* [Values Agreement](values_agreement): outlining the shared values we choose to guide our actions and efforts to implement RAD housing

### Participation agreements
Our current shared understanding of different aspects of participation are outlined across multiple agreements, including:
...
* [Development and Strategy (DAS) Crew](das_crew): responsible for ensuring that the Brassica Collective can implement the RAD housing approach to retrofit and decommodify existing suburban housing so that we, and others, can live in secure, resilient and affordable housing.
* [Knowledge Gardening Crew](knowledge_gardening_crew): responsible for documenting our project in ways that support us to implement our collective agreements internally, and share our processes as we learn about collective practices in public.


### Agreements for Living Collectively
* [Multi-Site Purchasing Agreement](multi_site_purchasing): describes the general approach of the Brassica Collective to purchasing land and houses. It applies to all site purchases. 
