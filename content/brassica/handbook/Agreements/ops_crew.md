...
## Scope of Delegation
The implementation of the above objectives are delegated to the Operations Crew, who may consult with Collective participants, with regard to:
* Determining the structure, time, location, and facilitation of meetings (e.g. assemblies and workshops).
* Contacting Brassica Collective participants or collaborators, or contacting outside parties on behalf of the Brassica Collective.
...
* Change the participant decision making process.
* Introduce new online tools or retire existing ones.
* Undertake any contract or binding commitment with other parties other than within the time and budget limits specified above.
* Keep any financial, legal or process information confidential from participants

## Timeline

Given the objectives outlined above, we expect the Operations Crew to be ongoing unless crew restructuring moves these responsibilities elsewhere.
