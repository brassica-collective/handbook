...
This agreement (_Version: 4.1_) will be reviewed in any of the following conditions:
...
- We assume that those who are not currently able to participate yet want to stay informed (for future participation possibilities and/or ad-hoc contributions to the project, such as attending working-bees) can continue to stay engaged in a ['supporter'](collaborators/) role.
