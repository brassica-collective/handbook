...
1.  **Purchase decision elements**
    ...
    6.  **Purchase Decision Process.** This will describe how the decision will be made to purchase a specific property. The recommendation is that the criteria and scoring rubric does most of the work. If there is to be a go/no-go decision per property, this section will outline the timeline for this in a way that can reasonably be done in time to make offers (ie, not “at the next assembly”, more like “within a 48 hour window of time, on Loomio”).
2.  **Purchase workflow**
